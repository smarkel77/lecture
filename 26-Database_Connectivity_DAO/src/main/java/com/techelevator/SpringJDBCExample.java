...
//		
//		try {
//			int numRowsAffected = dvdstoreJdbcTemplate.update(sqlCreateActor, 1000, "Craig", "Castelaz");
//			
//			if (numRowsAffected == 0) {
//				System.out.println("It didn't insert!");
//			}
...
//		
		 ...
		 * a new record.
		 */
		String sqlGetNextId = "SELECT nextval('seq_city_id') AS myID";
