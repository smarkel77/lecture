...
public class Lecture {
	...
	public static void main(String[] args) {
		 ...
		 * example of this is that there is a literal representation of a String
		 * (i.e. characters appearing between two double quotes. This is not the
		 * case for most classes)
		 */
		...
		char[] newArray = new char[hello1.length()];

		for (int i = 0; i < hello1.length(); i++) {
			newArray[i] = hello1.charAt(i);
		}
		...
		/*
		 * So, to compare the values of two objects, we need to use the equals
		 * method. Every object type has an equals method
		 */

		if (hello3.equals(hello2)) {
			System.out.println("They are equal!");
		} else {
			System.out.println(hello1 + " is not equal to " + hello2);
		}
