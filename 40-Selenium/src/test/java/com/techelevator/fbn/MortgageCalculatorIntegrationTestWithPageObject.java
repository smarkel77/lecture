...
public class MortgageCalculatorIntegrationTestWithPageObject {
	...
	@Test
	public void forms_can_be_edited_and_submitted_no_input() {
		MortgageCalculatorResultPage resultPage = homePage.clickMortgageCalculatorLink().submitForm();

		assertTrue(resultPage.getTitle().endsWith("Error report"));
	}	
}
